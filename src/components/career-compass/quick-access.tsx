...
import { Bot, FileText, MessagesSquare, Workflow, Briefcase } from "lucide-react"; // 1. Added Briefcase
...
const tools = [
    ...
    { name: 'CV Forge', icon: Briefcase, route: 'cvforge' }, // 2. Added CV Forge
...
export default function QuickAccess() {
    ...
    return (
        <Card className="shadow-sm">
            <motion.div 
                // 3. Updated grid layout to sm:grid-cols-5 to fit all 5 items on one row
                className="grid grid-cols-2 sm:grid-cols-5 gap-4 p-6" 
